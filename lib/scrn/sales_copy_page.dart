import 'package:copy_bud/services/sales_copy_service.dart';
...
class SalesCopyPage extends StatefulWidget {
  const SalesCopyPage({Key? key}) : super(key: key);

  @override
  State<SalesCopyPage> createState() => _SalesCopyPageState();
}

class _SalesCopyPageState extends State<SalesCopyPage> {
  final salesCopyService = SalesCopyService();
                  ...
                  setState(() {
                    s = prompt.isNotEmpty && prompt1.isNotEmpty
                        ? FutureBuilder<CopyModel>(
                            future: salesCopyService.postApi(
